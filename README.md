...
The following sections show `BigInt` in action. A number have been influenced by or taken outright from [Mathias Bynens's Big int v8 update, which incudes more details than this page.](https://developers.google.com/web/updates/2018/05/bigint)
